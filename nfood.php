...
$dbhost = 'localhost';
  ...
  if (mysqli_connect_errno())
   ...
   if($requestMethod == "POST") {
      ...
      $sql1 = "INSERT INTO nfood VALUES ('$dish','$no_dish','$time','$amount','$total')";
...
<option>100-Aloo Paratha</option>
<option>150-Veg Palao</option>
</select>
