...
$total = $no_dish * $amount;
      ...
      $sql1 = "INSERT INTO chats VALUES ('$dish','$no_dish','$time','$amount','$total')";
...
<option>100-pani puri</option>
<option>150-bhel puri</option>
</select>
