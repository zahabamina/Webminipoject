  ...
  if (mysqli_connect_errno())
   ...
   if($requestMethod == "POST") {
	...
	$total = $no_dish * $amount;
      ...
      $sql1 = "INSERT INTO refresh VALUES ('$dish','$no_dish','$time','$amount','$total')";
...
<center>
  <div class="transbox">
<br>
    <h1>REFRESHMENT</h1><br>

		<form action="" method="POST">

  <label>Enter the Choice:</label>
  
 <br> <select name="dish" >
 <option>Choose an option</option>
<option>Watermelon Juice</option>
...
<option>100-watermelon juice</option>
<option>150-cold coffee</option>
</select>
