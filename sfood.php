...
$dbhost = 'localhost';
  ...
  if (mysqli_connect_errno())
   ...
   if($requestMethod == "POST") {
      ...
      $sql1 = "INSERT INTO sfood VALUES ('$dish','$no_dish','$time','$amount','$total')";
...
<div class="navbar" style="font-style: italic;">
          ...
          <a href="cfood.php">Chinese Food</a>
...
<option>100-Idli and Vada</option>
<option>150-Masala Dosa</option>
</select>
